...
package com.semanticcms.theme.documentation.style.book;
...
@WebServlet("/theme-documentation/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/theme-documentation/style/apidocs/com.semanticcms.theme.documentation.style/com" + Objects.toString(req.getPathInfo(), ""),
